...
export default function Home() {
  ...
  const labelStyle: React.CSSProperties = {
    ...
    fontSize: 11, letterSpacing: 2, color: '#A8A9AD', display: 'block', marginBottom: 6
  }
    ...
    <>
        ...
        <div onClick={(e) => { if (e.target === e.currentTarget) closeModal() }} style={{
          ...
          <div style={{
            ...
            <button onClick={closeModal} style={{
              ...
              color: '#A8A9AD', fontSize: 24, cursor: 'pointer', lineHeight: 1
            }}>×</button>
            {success ? (
              ...
              <>
                ...
                <div style={{ fontSize: 14, color: '#A8A9AD', marginBottom: 28, lineHeight: 1.7 }}>
      ...
      <nav style={{
        ...
        <div className="nav-desktop">
          <Link href="/science" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 12, letterSpacing: 3, color: '#A8A9AD', textDecoration: 'none', marginRight: 32 }}>SEE THE SCIENCE</Link>
          ...
          <div style={{ background: '#080809', border: '1px solid #1A1A1E', borderRadius: 12, padding: 'clamp(24px,4vw,40px)', maxWidth: 680, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28, flexWrap: 'wrap', gap: 12 }}>
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 3, color: '#A8A9AD' }}>COACH DASHBOARD</div>
              ...
              <div key={i} style={{
                ...
                <div style={{ flex: 1, textAlign: 'left' }}>
                  ...
                  <div style={{ display: 'flex', gap: 8, marginTop: 4, flexWrap: 'wrap' }}>
                    {a.inputs.map((inp, j) => (
                      <span key={j} style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, letterSpacing: 1, color: '#A8A9AD' }}>{inp}</span>
                    ))}
                  </div>
                </div>
            ...
            <div style={{ marginTop: 20, paddingTop: 20, borderTop: '1px solid #111114', display: 'flex', gap: 'clamp(12px,3vw,24px)', flexWrap: 'wrap', justifyContent: 'center' }}>
              {[
                ...
                <div key={i} style={{ textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: 11, color: '#888898', marginTop: 2, maxWidth: 140 }}>{inp.desc}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section style={{ borderTop: '1px solid #111114', padding: 'clamp(60px,10vw,100px) clamp(16px,4vw,20px)' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div className="workout-grid">
            ...
            {/* Athlete view */}
            <div>
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 3, color: '#A8A9AD', marginBottom: 12, textAlign: 'center' }}>ATHLETE VIEW</div>
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        ...
                        <div style={{ fontSize: 12, color: '#A8A9AD', marginTop: 2 }}>{ex.sets} sets × {ex.reps} reps · {ex.weight}</div>
                      </div>
                      <div style={{ textAlign: 'right' }}>
                        ...
                        {!ex.done && !ex.active && <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, letterSpacing: 1, color: '#888898' }}>UP NEXT</div>}
                      </div>
                    </div>
                  </div>
                ))}
            ...
            {/* Coach view */}
            <div>
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 3, color: '#A8A9AD', marginBottom: 12, textAlign: 'center' }}>COACH VIEW</div>
              <div style={{ background: '#0D0D0F', border: '1px solid #1A1A1E', borderRadius: 12, padding: 'clamp(20px,3vw,28px)' }}>
                ...
                <div style={{ background: '#080809', borderRadius: 6, padding: '14px', marginBottom: 14 }}>
                  ...
                  <div style={{ fontSize: 13, color: '#A8A9AD', marginBottom: 12 }}>3 athletes flagged ELEVATED. Reduce their training load?</div>
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    <button style={{ padding: '8px 16px', background: 'transparent', border: '1px solid #242428', borderRadius: 4, fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 12, letterSpacing: 2, color: '#A8A9AD', cursor: 'pointer' }}>REVIEW INDIVIDUALLY</button>
                  </div>
                </div>
