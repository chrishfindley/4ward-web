    ...
    <div style={{ background: '#080809', color: '#F2F2F5', fontFamily: "'Barlow', sans-serif", overflowX: 'hidden' }}>
      ...
      {menuOpen && (
        <div style={{
          ...
          <Link href="/story" onClick={() => setMenuOpen(false)} style={{
            fontFamily: "'Bebas Neue', sans-serif", fontSize: 36, color: '#A8A9AD', textDecoration: 'none', letterSpacing: 3
          }}>OUR STORY</Link>
          ...
          <Link href="/" onClick={() => setMenuOpen(false)} style={{
            ...
            color: '#7B1020', textDecoration: 'none'
          }}>FOUNDING TEAMS</Link>
        </div>
      )}
      ...
      <nav style={{
        ...
        <div className="nav-desktop">
          <Link href="/story" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 12, letterSpacing: 3, color: '#A8A9AD', textDecoration: 'none', marginRight: 32 }}>OUR STORY</Link>
          <Link href="/" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 12, letterSpacing: 3, color: '#A8A9AD', textDecoration: 'none', marginRight: 32 }}>HOME</Link>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', maxWidth: 820, width: '100%' }}>
          <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 7, color: '#7B1020', marginBottom: 32 }}>THE SCIENCE BEHIND THE SCORE</div>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(52px,12vw,120px)', lineHeight: 0.88, marginBottom: 36 }}>
            ...
            <span style={{ color: '#7B1020' }}>RESEARCH.</span>
          </div>
          <p style={{ fontSize: 'clamp(14px,2vw,17px)', color: '#A8A9AD', lineHeight: 1.85, maxWidth: 560, margin: '0 auto 48px' }}>
          ...
          <a href="#stats" style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 12, letterSpacing: 3, color: '#A8A9AD', textDecoration: 'none' }}>SEE THE DATA ↓</a>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1060, margin: '0 auto' }}>
          ...
          <div className="stat-block" style={{ borderBottom: '1px solid #111114' }}>
            <div className="stat-number-col" style={{ borderRight: '1px solid #111114' }}>
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(80px,16vw,180px)', color: '#7B1020', lineHeight: 0.82 }}>1.7×</div>
            </div>
            <div className="stat-text-col">
              ...
              <p style={{ fontSize: 'clamp(14px,2vw,15px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 24 }}>
              ...
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: 2, color: '#888898' }}>MILEWSKI ET AL. — CLINICAL JOURNAL OF SPORTS MEDICINE, 2014</div>
            </div>
          </div>
          ...
          <div className="stat-block stat-block-reverse" style={{ borderBottom: '1px solid #111114', background: '#0D0D0F' }}>
            <div className="stat-text-col">
              ...
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: 2, color: '#888898' }}>FLATT & NAKAMURA — INTERNATIONAL JOURNAL OF SPORTS PHYSIOLOGY & PERFORMANCE, 2018</div>
            </div>
          ...
          <div className="stat-block">
            <div className="stat-number-col" style={{ borderRight: '1px solid #111114' }}>
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(80px,16vw,180px)', color: '#7B1020', lineHeight: 0.82 }}>5%</div>
            </div>
            <div className="stat-text-col">
              ...
              <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: 2, color: '#888898' }}>MAH ET AL. — STANFORD SLEEP LAB / SLEEP JOURNAL, 2011</div>
            </div>
          </div>
      ...
      <section style={{ borderTop: '1px solid #111114', padding: 'clamp(60px,10vw,100px) clamp(16px,4vw,20px)', background: '#0D0D0F' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 6, color: '#7B1020', marginBottom: 16 }}>THE THREE INPUTS</div>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(32px,5vw,60px)', color: '#F2F2F5', lineHeight: 0.95, marginBottom: 48 }}>
            WHAT 4WARD<br /><span style={{ color: '#7B1020' }}>MEASURES.</span>
          </div>
          ...
          <div style={{ display: 'flex', borderBottom: '1px solid #111114', marginBottom: 48 }}>
            {([
              ...
              <button key={tab.key} onClick={() => setActiveTab(tab.key)} style={{
                ...
                border: 'none', borderBottom: activeTab === tab.key ? '2px solid #7B1020' : '2px solid transparent',
                textAlign: 'left'
              }}>
                ...
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 'clamp(9px,1.5vw,11px)', letterSpacing: 2, color: activeTab === tab.key ? '#7B1020' : '#242428', marginTop: 2 }}>{tab.weight} OF SCORE</div>
              </button>
            ))}
          </div>
          ...
          {activeTab === 'hrv' && (
            <div className="tab-grid">
              <div>
                ...
                <p style={{ fontSize: 'clamp(14px,2vw,15px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 20 }}>HRV measures the variation in time between successive heartbeats — a direct window into autonomic nervous system balance. Elevated HRV indicates readiness. Suppressed HRV indicates the body is still recovering from stress.</p>
                <p style={{ fontSize: 'clamp(14px,2vw,15px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 20 }}>4Ward compares each athlete's daily HRV to their personal 7-day rolling baseline. An absolute HRV number means nothing without context. The comparison is everything.</p>
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: 2, color: '#888898', marginTop: 8 }}>FLATT & NAKAMURA, IJSPP 2018 · BUCHHEIT, EJAP 2014 · PLEWS ET AL., IJSPP 2013</div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                {[
                  ...
                  <div key={i} style={{ padding: 'clamp(16px,2vw,20px) clamp(16px,2vw,24px)', background: '#080809', borderLeft: '2px solid #7B1020' }}>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 3, color: '#7B1020', marginBottom: 8 }}>{item.label}</div>
                    <div style={{ fontSize: 14, color: '#A8A9AD', lineHeight: 1.7 }}>{item.text}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          {activeTab === 'sleep' && (
            <div className="tab-grid">
              <div>
                ...
                <p style={{ fontSize: 'clamp(14px,2vw,15px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 20 }}>Sleep is not passive recovery. Human growth hormone peaks during slow-wave sleep. Muscle protein synthesis accelerates through REM cycles. Motor pattern consolidation happens overnight. The adaptation from training does not occur in the gym — it occurs during sleep.</p>
                <p style={{ fontSize: 'clamp(14px,2vw,15px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 20 }}>The AAP recommends 8–10 hours for adolescent athletes. The national average is 6.8 hours. 4Ward makes that gap visible and actionable every morning.</p>
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: 2, color: '#888898', marginTop: 8 }}>MAH ET AL., 2011 · MILEWSKI ET AL., 2014 · AAP, 2016 · DATTILO ET AL., 2011</div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                {[
          ...
          {activeTab === 'rhr' && (
            <div className="tab-grid">
              <div>
                ...
                <p style={{ fontSize: 'clamp(14px,2vw,15px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 20 }}>Resting HR elevation above an athlete's personal baseline is a reliable early signal that cardiovascular recovery is incomplete. It detects physiological stress — from training, illness, or accumulated fatigue — often before the athlete subjectively reports feeling impaired.</p>
                <p style={{ fontSize: 'clamp(14px,2vw,15px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 20 }}>Combined with HRV, resting HR provides superior discrimination between recovered and under-recovered athletes than either metric in isolation.</p>
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 10, letterSpacing: 2, color: '#888898', marginTop: 8 }}>FOSTER ET AL., IJSM 1996 · HEDELIN ET AL., MSSE 2000</div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                {[
      ...
      <section style={{ borderTop: '1px solid #111114', padding: 'clamp(72px,12vw,120px) clamp(16px,4vw,20px)', textAlign: 'center' }}>
        <div style={{ maxWidth: 580, margin: '0 auto' }}>
          <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 7, color: '#7B1020', marginBottom: 28 }}>NOW ACCEPTING APPLICATIONS</div>
          ...
          <div style={{ fontSize: 'clamp(14px,2vw,16px)', color: '#A8A9AD', lineHeight: 1.85, marginBottom: 48 }}>
          ...
          <Link href="/" style={{
            ...
            background: '#7B1020', color: 'white', border: 'none', borderRadius: 4, cursor: 'pointer',
          ...
          <div style={{ marginTop: 24, fontFamily: "'Barlow Condensed', sans-serif", fontSize: 11, letterSpacing: 3, color: '#888898' }}>ANY SPORT · ANY PROGRAM · SUMMER 2026</div>
        </div>
      </section>
